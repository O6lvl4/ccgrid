...
function InputToolbar({ sending, canSend, onAttach, onSend }: {
  sending: boolean; canSend: boolean; onAttach: () => void; onSend: () => void;
}) {
  return (
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        ...
        <button type="button" onClick={onSend} disabled={!canSend}
          style={{
            ...
            border: 'none', background: canSend ? '#0ab9e6' : '#e8eaed',
